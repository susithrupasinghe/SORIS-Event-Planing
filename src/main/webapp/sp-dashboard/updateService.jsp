                                ...
                                <form action="<%=request.getContextPath()%>/updateServiceServlet" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="mb-3">
                                                <label for="price">Price</label>
                                                <input id="price" name="price" type="text" class="form-control" value="<%= price%>">value="<%= discount%>"
                                            </div>
                                            <div class="mb-3">
                                                <label for="Discount">Discount</label>
                                                <input id="Discount" name="discount" type="text" class="form-control" value="<%= discount%>">value="<%= category%>" value="<%= description%>"
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        &lt;%&ndash;                                <form action="<%=request.getContextPath()%>/NewServiceServlet" method="post" class="dropzone">&ndash;%&gt;
                                        <div class="fallback">
                                            <input name="file" type="file" multiple />
                                        </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="text-sm-end d-none d-sm-block">
                            &lt;%&ndash;                            Design & Develop by Themesbrand&ndash;%&gt;
                        </div>
                    </div>
                </div>
            </div>
...
&lt;%&ndash;&lt;%&ndash;popUp&ndash;%&gt;&ndash;%&gt;
&lt;%&ndash;<div class="modal fade" id="errormodel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">&ndash;%&gt;
...
&lt;%&ndash;                <h5 class="modal-title" id="staticBackdropLabel">Something wrong</h5>&ndash;%&gt;
...
&lt;%&ndash;                <p><%=request.getAttribute("error")%></p>&ndash;%&gt;
&lt;%&ndash;            </div>&ndash;%&gt;
&lt;%&ndash;            <div class="modal-footer">&ndash;%&gt;
&lt;%&ndash;                <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Ok</button>&ndash;%&gt;
&lt;%&ndash;            </div>&ndash;%&gt;
&lt;%&ndash;        </div>&ndash;%&gt;
&lt;%&ndash;    </div>&ndash;%&gt;
&lt;%&ndash;</div>&ndash;%&gt;
&lt;%&ndash;&lt;%&ndash;end popUp&ndash;%&gt;&ndash;%&gt;
